...
APP.prototype = {
  ...
  resizeAppWindow: function () {
    if (window.innerWidth < this.appWidth || window.mobilecheck()) {
    ...
    this.canvas.addEventListener('click', function (event) {
      if (this.useDynamicWidth) {
        if (event.clientY < this.bank.height) {
          let item = this.bank.withdraw(this.appWidthDynamic, this.bank.height, event.clientX, event.clientY, this.canvas.offsetLeft, this.canvas.offsetTop)
        ...
        if (event.clientY < this.bank.height) {
          let item = this.bank.withdraw(this.appWidth, this.bank.height, event.clientX, event.clientY, this.canvas.offsetLeft, this.canvas.offsetTop)
          console.log(item.itemName)
          this.inventory.addItem(item)
          this.updateCanvas()
        } else {
